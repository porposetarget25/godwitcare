...
export const RAW_COUNTRIES: CountryDialOption[] = [
...
export const COUNTRY_OPTIONS = [...RAW_COUNTRIES]
...
export const COUNTRY_NAMES = [...new Set(RAW_COUNTRIES.map((country) => country.name))]

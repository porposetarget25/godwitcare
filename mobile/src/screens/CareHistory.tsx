...
const s = StyleSheet.create({
  ...
  heroBadge:   { backgroundColor: '#FFD580', borderRadius: radius.full, paddingHorizontal: spacing.md, paddingVertical: 4 },
  ...
  rxBtn:     { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, backgroundColor: '#FFD580', borderRadius: radius.full, paddingVertical: 12, paddingHorizontal: spacing.xl, alignSelf: 'stretch', justifyContent: 'center' },

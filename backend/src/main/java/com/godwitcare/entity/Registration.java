...
public class Registration {
    ...
    private java.util.List<Traveler> travelers = new java.util.ArrayList<>();
    ...
    public String getPrimaryWhatsAppNumber() {
        return primaryWhatsAppNumber;
    }

    public void setPrimaryWhatsAppNumber(String v) {
        this.primaryWhatsAppNumber = v;
    }

    public String getCarerSecondaryWhatsAppNumber() {
        return carerSecondaryWhatsAppNumber;
    }

    public void setCarerSecondaryWhatsAppNumber(String v) {
        this.carerSecondaryWhatsAppNumber = v;
    }
    ...
    public void setLongTermMedication(Boolean v) {
        this.longTermMedication = v;
    }
    ...
    public void setHealthCondition(Boolean v) {
        this.healthCondition = v;
    }
    ...
    public void setFitToFlyCertificate(Boolean v) {
        this.fitToFlyCertificate = v;
    }
    ...
    public void setTravellingFrom(String v) {
        this.travellingFrom = v;
    }
    ...
    public void setTravellingTo(String v) {
        this.travellingTo = v;
    }
    ...
    public void setTravelStartDate(LocalDate v) {
    ...
    public void setTravelEndDate(LocalDate v) {
    ...
    public void setPackageDays(Integer v) {
        this.packageDays = v;
    }
